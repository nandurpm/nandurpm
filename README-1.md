<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Nandakumar%20M&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Electrical%20Design%20%26%20Development%20Engineer%20%7C%20Escalator%20Systems%20Specialist&descAlignY=62&descSize=16"/>

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=70A5FD&center=true&vCenter=true&width=750&lines=Electrical+Design+%26+Development+Engineer;Escalator+%26+Elevator+Systems+Specialist;Electronics+%7C+Automation+%7C+Embedded+Systems;Linux+Enthusiast+%7C+Open-Source+Explorer)](https://git.io/typing-svg)
...
class NandakumarM:
    ...
    fun_fact = "Scored 95% in SSLC & loves debugging circuits like code 🔌"

    def motto(self):
        return "Engineer by training. Problem-solver by nature. 🚀"
```
...
- 📋 Development and revision of **engineering drawings and technical documentation** in compliance with design standards.
- 🔧 Support for **escalator control systems, electrical panels**, and field implementation activities coordinated with installation teams.
- 🤝 Cross-functional coordination with **production, installation, and service teams** to ensure design compliance and resolve technical issues.
- 🔄 Engineering **change management and documentation control**, ensuring accurate revision histories.
- 🔍 **Technical troubleshooting and root cause analysis** of electrical system faults in escalator units.
...
- 🔧 Actively supported **manufacturing and process improvement activities** to reduce defect rates.
...
- 🔩 Operated **CNC machinery** for precision automotive component manufacturing with strict tolerances.
- 📏 Conducted **production monitoring and dimensional inspections** to maintain quality output.
...
> ![Video Production](https://img.shields.io/badge/Video%20Production-9B59B6?style=flat-square) ![Post-Production](https://img.shields.io/badge/Post--Production-1ABC9C?style=flat-square) ![Digital Media](https://img.shields.io/badge/Digital%20Media-E67E22?style=flat-square)
...
|:---|:---|:---|
| **[BOM Validator Web App](https://github.com/nandakumarkdpm)** | HTML5, JavaScript, SheetJS, jsPDF | Single-file escalator BOM validation tool; auto-detects EG01–EG29 sections; Excel/PDF export; admin controls |
| **Escalator Electrical Schematics** | AutoCAD Electrical, MS Office | Full electrical schematic suite for escalator control panels & wiring systems at Johnson Escalators |
| **All India Radio FM Training Project** | Electronics, RF Systems | Industrial training covering communication systems, broadcasting equipment & RF electronics at AIR Manjeri |
...
| 🏅 | Achievement | Details |
|:---:|:---|:---|
| 🎓 | **Diploma in Electronics Engineering** | Govt. Polytechnic College, Perinthalmanna – Board of Technical Education, Kerala |
| 📡 | **Industrial Training – All India Radio FM** | Electronics, Communication Systems & Broadcasting Equipment, Manjeri |
| 🏆 | **SSLC Board Exam – 95%** | Government HSS Kadungapuram, Malappuram – State Board 2014 |
| 📊 | **Plus Two – 79%** | Government HSS Kadungapuram, Malappuram – State Board 2016 |
| ⚡ | **Current Role – Johnson Lifts & Escalators** | Electrical Design & Development Engineer – escalator electrical systems & documentation |
...
[![Location](https://img.shields.io/badge/Location-Malappuram%2C%20Kerala%2C%20India-38BDAE?style=for-the-badge&logo=google-maps&logoColor=white)](https://maps.google.com/?q=Malappuram,Kerala,India)
[![GitHub](https://img.shields.io/badge/GitHub-Profile-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/nandakumarkdpm)
...
`🧠 Strong Analytical Skills` &nbsp; `🔍 Attention to Detail` &nbsp; `⚡ Quick Learner` &nbsp; `🤝 Team Collaboration` &nbsp; `🛠️ Problem Solving` &nbsp; `📝 Technical Documentation` &nbsp; `🔄 Adaptability`
...
| 🏗️ Engineering | 💻 Technology | 🎨 Creative |
|:---:|:---:|:---:|
| Escalator & Elevator Tech | AI Applications | Photography |
| Electrical System Design | Linux & Open-Source | Video Editing |
| Industrial Automation | Embedded Systems | Reading Tech Articles |
| Electronics & R&D | Computer Technology | Exploring New Tools |
